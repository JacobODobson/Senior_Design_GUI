...
#ifndef INC_TRILATERATION_H_
#define INC_TRILATERATION_H_
...
int GetLocation(vec3d *best_solution, int use4thAnchor, vec3d* anchorArray, double *distanceArray);

double vdist(const vec3d v1, const vec3d v2);

#endif /* INC_TRILATERATION_H_ */
